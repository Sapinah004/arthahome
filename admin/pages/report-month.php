    ...
    <div class="mt-5 w-full h-full  block overflow-auto font-yantramanav whitespace-nowrap">
        ...
        <div>
            <div class="flex space-x-3 mt-5 items-center">
                <div class="text-lg font-medium">Pilih Bulan :</div>
                <form action="" method="post">
                    <select id="report-select" name="month" class="w-48 px-3 py-1 border-2 border-primary rounded-md">
                    ...
                    <select id="report-select" name="year" class="w-28 px-3 p-1 border-2 border-primary rounded-md">
                    ...
                    <button name="submit" type="submit" class="px-5 py-1 border-2 border-primary bg-primary rounded-md text-white hover:bg-blue-900 ease-in-out duration-300">
                        Pilih
                    </button>
                </form>
            </div>
            ...
            <?php
                        ...
                        echo '<div class="mt-5 font-yantramanav font-semibold">Tidak ada data pembelian rumah pada bulan ini</div>';
                    }
                }
            ?>
        </div>
