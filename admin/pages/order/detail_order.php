    ...
    <div class="pt-2 pb-5 font-yantramanav">
        ...
        <div class="mt-6 px-5">
            <div class=" p-5 shadow-md rounded-md border border-slate-400">
                    ...
                    <div class="columns-2 space-y-6 mt-5">
                        ...
                        <div class="break-inside-avoid">
                            ...
                            <div class="flex space-x-3"> 
                                ...
                                <button>
                                    <a class="px-4 text-sm py-2.5 text-white bg-green-500 hover:bg-green-700 ease-in-out duration-300 rounded-md" href="https://api.whatsapp.com/send/?phone=<?php echo $data['telephone']?>&text=Hai+ada+yang+bisa+saya+bantu+?" target="blank" class="basis-1/2"> Whatsapp Pembeli </a>
                                </button>
                            </div>
                        </div>
                        <div class="break-inside-avoid">
                        ...
                        <div class="break-inside-avoid">
                            ...
                            <button class="">
                                <a href="https://api.whatsapp.com/send/?phone=<?php echo $data['telephone']?>&text=Hai+ada+yang+bisa+saya+bantu+?" target="blank" class="px-4 py-2.5 text-sm bg-green-500 text-white rounded-md hover:bg-green-700 ease-in-out duration-300">Kirim Reminder</a>
                            </button>
                        </div>
                        <div class="break-inside-avoid">
                            <div class="capitalize mb-3">
                            ...
                            <div id="gambar_ktp" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                                <div class="relative w-full h-full max-w-2xl max-h-[35rem] overflow-y-auto md:h-auto">
                                    <div class="relative pb-5 bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div>
                                            <img src="../../User/assets/images/ktp/<?php echo $data['gambar_ktp']?>" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="gambar_kk" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                                <div class="relative w-full h-full max-w-2xl max-h-[35rem] overflow-y-auto md:h-auto">
                                    <div class="relative pb-5 bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div>
                                            <img src="../../User/assets/images/kartu-keluarga/<?php echo $data['gambar_kk']?>" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="surat_npwp" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                                <div class="relative w-full h-full max-w-2xl max-h-[35rem] overflow-y-auto md:h-auto">
                                    <div class="relative pb-5 bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div>
                                            <img src="../../User/assets/images/surat-npwp/<?php echo $data['gambar_npwp']?>" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!-- <div class="">
                        <div class="flex space-x-3 mb-2">
                            <span class="basis-1/5">Nomor Pesanan </span>
                            <span class="basis-1/2"> : <?php echo $data['id_order']?></span>
                        </div>
                        <div class="flex space-x-3 mb-2">
                            <span class="basis-1/5">Tanggal Pembelian </span>
                            <span class="basis-1/2"> : <?php echo getHari($date)?>, <?php echo date_format(new DateTime($data['tanggal']), "d/m/Y")?></span>
                        </div>
                        <div class="flex space-x-3 mb-2">
                            <span class="basis-1/5">Nama Pembeli </span>
                            <span class="basis-1/2 capitalize"> : <?php echo $data['username']?> </span>
                        </div>
                        <div class="flex items-center space-x-3 w-full mb-2">
                                <span class="basis-1/5">Nomor Telephone </span>
                                <a href="tel:<?php echo $data['telephone']?>" class="basis-1/6"> : <?php echo $data['telephone']?> </a>
                            <button>
                                 <a class="px-5 py-2.5 text-white bg-blue-700 hover:bg-blue-900 ease-in-out duration-300 rounded-md" href="tel:<?php echo $data['telephone']?>" class="basis-1/2"> Hubungi Pembeli </a>
                            </button>
                            <button>
                                 <a class="px-5 py-2.5 text-white bg-green-500 hover:bg-green-700 ease-in-out duration-300 rounded-md" href="https://api.whatsapp.com/send/?phone=<?php echo $data['telephone']?>&text=Hai+ada+yang+bisa+saya+bantu+?" target="blank" class="basis-1/2"> Whatsapp Pembeli </a>
                            </button>
                        </div>
                        <div class="flex space-x-3 items-center mb-2 mt-7">
                            <span class="basis-1/5">Email </span>
                            <a href="mailto:<?php echo $data['email']?>" class="basis-1/4 break-all"> : <?php echo $data['email']?></a>
                            <button>
                                 <a class="px-5 py-2.5 text-white bg-green-500 hover:bg-green-700 ease-in-out duration-300 rounded-md" href="mailto:<?php echo $data['email']?>" class="basis-1/2"> Hubungi Pembeli </a>
                            </button>
                        </div>
                        <div class="flex space-x-3 items-center mb-2 mt-7">
                                <span class="basis-1/5">Jatuh Tempo Pembayaran </span>
                                <span class="basis-1/4 break-all font-bold"> : Setiap tanggal <?php echo date_format(new DateTime($data['tanggal']), "d")?></span>
                            <button class="">
                                <a href="https://api.whatsapp.com/send/?phone=<?php echo $data['telephone']?>&text=Hai+ada+yang+bisa+saya+bantu+?" target="blank" class="px-5 py-2.5 bg-green-500 text-white rounded-md hover:bg-green-700 ease-in-out duration-300">Kirim Reminder</a>
                            </button>
                        </div>
                    </div>
                    <div class="flex space-x-3 items-center mt-7">
                        <div>
                            <button type="button" data-modal-toggle="gambar_ktp" class="flex  space-x-2 items-center px-4 py-2 bg-green-500 hover:bg-green-700 ease-in-out duration-300 text-white rounded-md">
                                <i class="fa-regular fa-eye"></i>
                                <span>Lihat KTP</span>
                            </button>
                            <div id="gambar_ktp" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                        ...
                        <div>
                            <button type="button" data-modal-toggle="gambar_kk" class="flex space-x-2 items-center px-4 py-2 bg-green-500 hover:bg-green-700 ease-in-out duration-300 text-white rounded-md">
                                <i class="fa-regular fa-eye"></i>
                                <span>Lihat Kartu Keluarga</span>
                            </button>
                            <div id="gambar_kk" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                        ...
                        <div>
                            <button type="button" data-modal-toggle="surat_npwp" class="flex space-x-2 items-center px-4 py-2 bg-green-500 hover:bg-green-700 ease-in-out duration-300 text-white rounded-md">
                                <i class="fa-regular fa-eye"></i>
                                <span>Lihat NPWP</span>
                            </button>
                            <div id="surat_npwp" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                                            ...
                                            <div id="defaultModal<?php echo $y?>" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                                                <div class="relative w-full h-full max-w-2xl max-h-[35rem] overflow-y-auto md:h-auto">
                                                    <div class="relative pb-5 bg-white rounded-lg shadow dark:bg-gray-700">
                                                        ...
                                                        <div>
                                                            <img src="../../User/assets/images/bukti_pembayaran/<?php echo $data['gambar']?>" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <td>
                                    <?php
                                        if($data['status_pembayaran'] == 1){
                                           ?>
                                             <button>
                                                <a class="px-4 text-sm py-2.5 text-white bg-green-500 hover:bg-green-700 ease-in-out duration-300 rounded-md" href="https://api.whatsapp.com/send/?phone=<?php echo $data['telephone']?>&text=Pelanggan+kami+yang+terhormat,+bukti+pembayaran+rumah+anda+telah+diterima,+Terimakasih" target="blank" class="basis-1/2"> Whatsapp Pembeli </a>
                                            </button>
                                           <?php
                                        }elseif($data['status_pembayaran'] == 2){
                                            ?>
                                             <button>
                                                <a class="px-4 text-sm py-2.5 text-white bg-green-500 hover:bg-green-700 ease-in-out duration-300 rounded-md" href="https://api.whatsapp.com/send/?phone=<?php echo $data['telephone']?>&text=Pelanggan+kami+yang+terhormat,+bukti+pembayaran+rumah+anda+ditolak+karena+tidak+sesuai+dengan+ketentuan.+Harap+cek+kembali+terimakasih" target="blank" class="basis-1/2"> Whatsapp Pembeli </a>
                                            </button>
                                            <?php
                                        }else{
