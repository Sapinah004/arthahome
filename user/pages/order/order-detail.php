            ...
            <table class="table-auto w-full border-collapse border mt-6 bg-slate-200 border-b border-slate-100">
                ...
                <tbody>
                    <?php
                        $i = 0;
                        $x = 0;
                        $sql = mysqli_query($connect, "SELECT * FROM tb_pembayaran WHERE id_user = '".$_SESSION['id_user']."' AND id_order = '".$_GET['order']."'  ORDER BY tanggal DESC");
