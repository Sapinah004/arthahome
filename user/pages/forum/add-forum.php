...
<div class="pt-32 lg:pt-52 pb-24 px-5 container mx-auto max-w-4xl font-yantramanav">
    <a class="text-secondary font-semibold text-xl" href="../pages/index.php?page=list-forum">
    ...
    <div class="mt-5 text-primary bg-gray-100 p-4 md:p-7 rounded-xl">
        <form method="post">
            <div>
                ...
                <input id="judul" autocomplete="off" name="judul" class="text-lg w-full px-3 py-2 bg-gray-200 rounded-md mt-2 border-0 mb-8 focus:border-0 focus:outline-0 focus:outline-none focus:border-primary focus:ring-primary block focus:ring-2" type="text" placeholder="Masukkan judul topik anda">
            </div>
            <div>
                <label for="topik" class="font-semibold after:content-['*'] after:ml-1 after:text-secondary">Topik / Pertanyaan</label>
                <textarea id="topik" name="topik" class="text-lg w-full px-3 py-2 bg-gray-200 border-0 rounded-md mt-2 focus:border-0 focus:outline-0 focus:outline-none focus:border-primary focus:ring-primary block focus:ring-2" name="topik" id="" cols="30" rows="7" placeholder="Masukkan topik atau pertanyaan yang ingin didiskusikan"></textarea>
            </div>
