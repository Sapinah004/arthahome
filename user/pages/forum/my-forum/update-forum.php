    ...
    <div class="mt-3 md:mt-7 bg-gray-100 p-4 md:p-7 rounded-xl">
        <form method="post">
            <div>
                ...
                <input id="judul" required="required" autocomplete="off" name="judul" class="text-lg w-full px-3 py-2 bg-gray-200 border-0 rounded-md mt-2 mb-8 focus:border-0 focus:outline-0 focus:outline-none focus:border-primary focus:ring-primary block focus:ring-2 focus:shadow-md" type="text" value="<?php echo $data['judul']?>">
            </div>
            <div>
                ...
                <textarea id="topik" required="required" name="topik" class="text-lg w-full px-3 py-2 bg-gray-200 border-0 rounded-md mt-2 focus:border-0 focus:outline-0 focus:outline-none focus:border-primary focus:ring-primary block focus:ring-2 focus:shadow-md" name="topik" id="" cols="30" rows="7"><?php echo $data['topik']?></textarea>
            </div>
